...
import { site, career, faqInfantil, processStepsInfantil } from "@/config/site";
...
const TITLE = "Acompanhamento Psicológico Infantil | Kelle Tavares";
const DESCRIPTION =
  "Conheça o trabalho de Kelle Tavares com acompanhamento psicológico infantil, sua trajetória profissional e informações sobre atendimento.";
